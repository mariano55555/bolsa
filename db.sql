...
INSERT INTO `areas` (`id`, `name`, `created`, `modified`, `created_by`, `modified_by`, `active`) VALUES
	(1, 'AdministraciÃ³n', '2014-06-09 06:56:54', '2014-06-09 06:56:54', 1, 1, 1),
	(2, 'Finanzas', '2014-06-09 06:57:01', '2014-06-09 06:57:01', 1, 1, 1);
...
-- Volcando datos para la tabla jobsearch.experiences: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla jobsearch.experiences_jobs: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla jobsearch.industries: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla jobsearch.jobs: ~2 rows (aproximadamente)
