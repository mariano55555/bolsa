...
<?php echo $this->Form->create('IndustriesJob'); ?>
	<fieldset>
		<legend><?php echo __('Edit Industries Job'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('IndustriesJob.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('IndustriesJob.id'))); ?></li>
