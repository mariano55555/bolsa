  ...
  echo $this->BreadCrumb->trail('Area', array('Dashboard' => 'Dashboard', '../areas' => 'Area'), 'Editar area'); 
  ?>
<div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                    	<?php echo $this->Form->create('Area', array('type' => 'file', "class" => "form-horizontal", "role" => "form", 'inputDefaults' => array('label' => false, 'div'=>false))); 
                    		  echo $this->Form->input("id");
                    	?>
                            <div class="form-group">
                                <label for="ProductName" class="col-lg-2 col-sm-2 control-label">Area</label>
