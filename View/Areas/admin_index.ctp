  ...
  echo $this->BreadCrumb->trail('Areas', array('dashboard' => 'Dashboard'), 'Areas'); 
  ?>
          ...
          <?php echo $this->Html->link(__('<i class="fa fa-shopping-cart"></i> Nueva area'), 
            ...
            <div class="adv-table">
                <table  class="display table table-bordered table-striped" id="dynamic-table">
					...
					<tr>
						<td style="vertical-align:middle;"><?php echo h($area['Area']['name']); ?>&nbsp;</td>
						<td style="vertical-align:middle;"><?php echo h($area['Area']['created']); ?>&nbsp;</td>
						<td style="vertical-align:middle;"><?php echo h($area['Area']['modified']); ?>&nbsp;</td>
						<td style="vertical-align:middle; text-align:center"><?php echo h($area['Area']['active'] == 1) ? '<div class="alert alert-success fade in" style="margin-bottom:0px"><strong>Active</strong></div>' : '<div class="alert alert-block alert-danger fade in" style="margin-bottom:0px"><strong>Inactive</strong></div>'; ?>&nbsp;</td>
						<td class="actions" style="vertical-align:middle; text-align:center">
							...
							<?php echo $this->Form->postLink(__('<i class="fa fa-exclamation-triangle"></i> Delete'), 
				                ...
				                __('Are you sure you want to delete # %s?', $area['Area']['name'])
				            ); ?>
						</td>
					</tr>
					<?php endforeach; ?>
