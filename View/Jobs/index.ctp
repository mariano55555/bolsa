<div class="jobs index">
	...
	<tr>
		...
		<td><?php echo h($job['Job']['content']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['skills']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['salary']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['created']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['modified']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['modified_by']); ?>&nbsp;</td>
		<td><?php echo h($job['Job']['tags']); ?>&nbsp;</td>
		<td class="actions">
