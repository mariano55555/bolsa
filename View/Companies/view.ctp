...
<h2><?php echo __('Company'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($company['CreatedBy']['name'], array('controller' => 'users', 'action' => 'view', $company['CreatedBy']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo $this->Html->link($company['ModifiedBy']['name'], array('controller' => 'users', 'action' => 'view', $company['ModifiedBy']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php foreach ($company['Job'] as $job): ?>
		<tr>
