<?php
echo $this->Html->script('admin/calendar/clndr', array('block' => 'script'));
echo $this->Html->script('admin/calendar/evnt.calendar.init', array('block' => 'script'));
echo $this->Html->script('admin/calendar/moment-2.2.1.js', array('block' => 'script'));
echo $this->Html->script('http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js', array('block' => 'script'));
 echo $this->Html->css('admin/clndr', null, array('inline' => false));
